        ...
        stage('Deploy to Instance 1') {
            steps {
                script {
                    ...
                    sh 'scp -i ~/.ssh/authorized_keys https://github.com/Tranck04/pipetest.git ec2-user@18.208.164.160:/var/www/html/'
                }
            }
        }
        ...
        stage('Deploy to Instance 2') {
            steps {
                script {
                    ...
                    sh 'scp -i ~/.ssh/authorized_keys https://github.com/Tranck04/pipetest.git ec2-user@54.210.130.119:/var/www/html/'
                }
            }
        }
    }
